...
var METER_WIDTH_RATIO = 0.63;
var TANK_WIDTH_RATIO = 0.8;
...
var Thermometer = function (_Component) {
  ...
  _createClass(Thermometer, [{
    ...
    value: function render() {
      ...
      var meterWidth = this.options.width * METER_WIDTH_RATIO + 'px';
      var tankWidth = this.options.width * TANK_WIDTH_RATIO + 'px';
      this._createIntervals();
      var stepIntervals = this._createIntervalsUI(this.options.intervals);

      return _react2.default.createElement(
        'div',
        { style: { height: height, width: width }, className: 'thermometer ' + size + ' ' + theme },
        _react2.default.createElement('div', { className: 'thermometer__draw-a' }),
        _react2.default.createElement('div', { style: { width: tankWidth, bottom: 0.013 * this.options.height + 'px' }, className: 'thermometer__draw-b' + reverse }),
        _react2.default.createElement(
          'div',
          { style: { width: meterWidth }, className: 'thermometer__meter' },
          _react2.default.createElement(
            'ul',
